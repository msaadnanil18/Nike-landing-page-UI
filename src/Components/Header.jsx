...
function Header() {
  return (
    <>
    <header>
        <div className="uppercase font-bold md:flex justify-between text-2xl md:text-7xl" >
      ...
      <div className="mx-40 space-y-5 " >
            ...
            <div className="flex">
            <div className=" bg-red-600 cursor-pointer p-2 rounded-md md:text-lg font-semibold hover:bg-green-400 " >shop Now</div>
            <div className="bg-slate-100 cursor-pointer p-2 mx-10 border rounded-md font-semibold md:text-lg hover:bg-slate-400 " >Category</div>
            </div>
